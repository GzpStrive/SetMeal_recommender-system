# -*- coding: utf-8 -*-
"""
Created on Wed May 29 10:37:15 2019
...
class xieTong_algorithm(object):
    ...
    def sim_Euclid(self, pref, preson1, preson2):
        ...
        sum_of_squres = sum(
            [pow(pref[preson1][item] - pref[preson2][item], 2) for item in pref[preson1] if item in pref[preson2]])
        # 将相似度归一
...
if __name__ == '__main__':
    if len(sys.argv) > 3:
        ...
        for i in range(len(menus)):
            items.setdefault(menus[i], int(points[i]))
