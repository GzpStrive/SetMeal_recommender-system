...
<%
		...
		System.out.println("allfood_3showGet_rules,foodcarArr=="+foodcarArr);
		...
		//本地
		//Map<Integer, String> map2 = pyT.get_rules1(name_point,request.getSession().getServletContext().getRealPath("/"));
		//云服务器
		Map<Integer, String> map2 = pyT.get_rules(name_point);  
		System.out.println("allfood_3showGet_rules,map2======"+map2);
		...
		try {
			...
			System.out.println("allfood_3showGet_rules,MNlist====="+MNlist);
		} catch (Exception e) {
